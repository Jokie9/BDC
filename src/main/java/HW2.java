...
public class HW2 {
    public static void main(String[] args) throws IOException {
        ...
        //broadcast variable
        Broadcast<HashMap<Integer, Long>> sharedClusterSizes = sc.broadcast(new HashMap<Integer, Long>());
        ...
        //SAVE CLUSTERS SIZE
        fullClustering.values().countByValue().forEach((key,value) -> sharedClusterSizes.value().put(new Tuple2<>(key, value)));
        ...
        clusteringSample = sc.broadcast(fullClustering.mapPartitionsToPair(element -> {
            ...
            while(element.hasNext()){
                ...
                Long size = sharedClusterSizes.value().get(tuple._2());
                Random r = new Random();
        ...
        JavaPairRDD<Integer, Double> temp3 = fullClustering.mapPartitionsToPair(element->{
            ...
            for(int i = 0; i < k; i++)
                fractions[i] = 1/Double.min(t, sharedClusterSizes.value().get(i));
